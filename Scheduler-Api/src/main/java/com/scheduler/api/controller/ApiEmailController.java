...
public class ApiEmailController {
    ...
    @ApiOperation(value = "获取${hello}的配置",httpMethod = "GET")// 功能描述
    @RequestMapping("/hello")
    public String from() {
        return this.hello;
    }
    @ApiOperation(value ="获取business的hello方法",httpMethod = "GET")// 功能描述
    @RequestMapping("/hello/{name}")
    public String index(@PathVariable("name") String name){
      return   emailRemote.hello(name);
    }
    @ApiOperation(value ="调用business发送一个邮件",httpMethod = "POST")// 功能描述
